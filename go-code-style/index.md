...
- 错误描述建议
  ...
  - 指定不等时，请使用单词而不是符号。例如，`must be less than 256、must be greater than or equal to 0`。
  - 指定数字范围时，请尽可能使用包含范围。
...
[可直接套用的Go编码规范](https://github.com/marmotedu/geekbang-go/blob/master/可直接套用的Go编码规范.md)
